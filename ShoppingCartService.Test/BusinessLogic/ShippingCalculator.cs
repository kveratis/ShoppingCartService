...
{
    public sealed class ShippingCalculatorShould
    {
        [Fact]
        public void Return_Zero_Cost_With_Empty_Cart()
        {
            var cart = CreateCart();
        ...
        public void Return_Varied_Cost_Depending_On_Customer_Type_And_Shipping_Type(CustomerType customerType, ShippingMethod shippingMethod, double expectedCost)
        {
        ...
        public void Return_Varied_Cost_Depending_On_Customer_Location_Relative_To_Warehouse_Locationstring(string customerCity, string customerCountry, string warehouseCity, string warehouseCountry, double expectedCost)
        {
